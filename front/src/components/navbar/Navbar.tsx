...
const Navbar: React.FC = () => {
  ...
  return (
    <div className="nav">
      ...
      <div className={clicked ? "nav__button clicked" : "nav__button"} onClick={() => setClicked(!clicked)} >
      ...
      <div className={clicked ? "nav__links clicked" : "nav__links"} onClick={() => setClicked(!clicked)}>
