      ...
      <div className="informations">
        ...
        <ul>
          <li>
            ...
            <p className="renseignement">Espace Municipal Jean-Baptiste Coste, Chemin Aimé-Genoud, 83500 La Seyne sur Mer</p>
          </li>
          <li>
            <h3> - Nous écrire</h3>
						<br />
            <p>Même si rien ne remplace un contact direct pour découvrir nos paniers et qui nous sommes, vous pouvez nous demander des informations par mail :</p>
